...
Pod::Spec.new do |s|
  s.name             = 'DKSpecTest01'
  s.version          = '0.1.0'
  s.summary          = 'A short description of DKSpecTest01.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/zhangdekai/DKSpecTest01'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'zhangdekai' => 'zdkzhuizhu@163.com' }
  s.source           = { :git => 'https://github.com/zhangdekai/DKSpecTest01.git', :tag => s.version.to_s }
